...
export const MicrophoneIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a6 6 0 006-6v-1.5a6 6 0 00-12 0v1.5a6 6 0 006 6zM12 12.75V18.75m0 0a3 3 0 01-3-3V12m3 3.75a3 3 0 003-3V12m-9 6.75h12" />
  </svg>
);
...
// Note: To use two different icons from the same base name, they are imported with aliases in the files that use them.
export const StarIcon: React.FC<React.SVGProps<SVGSVGElement> & { variant?: 'solid' | 'outline' }> = ({ variant = 'outline', ...props }) => {
  if (variant === 'solid') {
    return (
